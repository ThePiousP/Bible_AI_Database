"""
Convert gazetteer text files to Prodigy JSONL pattern format with label filtering.
"""
import json
...
if __name__ == "__main__":
    # Example: Filter to specific labels
    FILTER_LABELS = ['DEITY', 'PERSON', 'LOCATION']  # Modify as needed

    convert_gazetteers_to_patterns(
        label_rules_path="label_rules.yml",
        output_path="prodigy_patterns_filtered.jsonl",
