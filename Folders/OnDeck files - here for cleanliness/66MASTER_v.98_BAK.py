# Bible Scraper version: 0.98
# This script scrapes Bible verses from a specified version and saves them to text files.
# It includes a menu for user interaction, allowing the user to scrape specific books or the entire Bible.
# It also includes debug options for logging and modifying settings.
...
def main_menu():
    while True:
        print(f"\n==== AARON'S GAME [Scraper v{scraper.config.get('version', '0.98')}] ====")
        print("\n===== MAIN MENU =====")
